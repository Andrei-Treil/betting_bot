...
if __name__ == '__main__':
    #../NBA/games/2023-2024_nba_season.csv
    ...
    res = one_szn_par(games_df,'2021-22')
    ...
    games_df = pd.read_csv('NBA/games/2020-2021_season_inj.csv',sep=',',names=['date','away','away_pt','home','home_pt'])
    ALL_TEAMS_CONC = dict.fromkeys(TEAM_ABR_TO_URL.keys())
    res = one_szn_par(games_df,'2020-21')
